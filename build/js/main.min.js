...
/* harmony import */ var _modules_map_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_modules_map_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _modules_navigation_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/navigation.js */ "./js/modules/navigation.js");
/* harmony import */ var _modules_form_validation_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/form-validation.js */ "./js/modules/form-validation.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_form_validation_js__WEBPACK_IMPORTED_MODULE_3__["validatePhoneInput"])();
...
var navElement = document.querySelector('[data-header-nav]');
var headerWrapperElement = document.querySelector('[data-header-wrapper]');
var logoElement = document.querySelector('[data-header-logo]');
var toggleElement = document.querySelector('[data-header-toggle]');
var navLinkElements = document.querySelectorAll('[data-header-nav-link]');
var mainElement = document.querySelector('main');
var headerElement = document.querySelector('header');
var mainWrapperElement = document.querySelector('[data-main-wrapper]');
...
if (headerWrapperElement && navElement) {
  ...
  var _iterator = _createForOfIteratorHelper(navLinkElements),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var navLinkElement = _step.value;
